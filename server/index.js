...
${input_mode === 'suggested' ? `РЕЖИМ «СЮРПРИЗ» — ВИРУСНЫЙ ДИАЛОГОВЫЙ РОЛИК ТЕКУЩЕГО ДНЯ 🎬

Формат: 8-секундная вирусная диалоговая сценка под РФ/СНГ.

════ АБСОЛЮТНЫЕ ПРИОРИТЕТЫ ════
№1 — ТРЕНД ИМЕННО ТЕКУЩЕГО ДНЯ. Ролик должен ощущаться как свежий кусок сегодняшней ленты, сегодняшнего юмора, сегодняшних пересылок.
№2 — ШУТКА ИМЕННО ТЕКУЩЕГО ДНЯ. Не «вне времени», не «универсальная», а та, что звучит свежо СЕЙЧАС.
№3 — РЕАЛЬНО СМЕШНО, НАГЛО, ЖИВО, ПЕРЕСЫЛАЕМО под РФ/СНГ.

ТЫ НЕ ИМЕЕШЬ ПРАВА строить ролик от картинки, от люкса, от пафоса или от красивой сцены.
ТЫ ВСЕГДА ОБЯЗАН строить ролик ОТ ШУТКИ: от самой актуальной комедийной механики, от свежего мемного конфликта, от живой фразы, от вайба сегодняшней ленты.

════ ШАГ 0 — ОПРЕДЕЛИ ТРЕНД СЕГОДНЯШНЕГО ДНЯ (обязательно перед каждой идеей!) ════
Перед генерацией ОБЯЗАТЕЛЬНО определи:
• Какой мемный вайб актуален ИМЕННО СЕГОДНЯ?
• Какой тип шутки актуален ИМЕННО СЕГОДНЯ?
• Какой тип конфликта люди реально пересылают ИМЕННО СЕГОДНЯ?
• Какая интонация диалога ощущается свежей ИМЕННО СЕГОДНЯ?
• Какая механика панчлайна звучит по-современному ИМЕННО СЕГОДНЯ?
...
════ ШАГ 1 — НАЙДИ САМУЮ АКТУАЛЬНУЮ КОМЕДИЙНУЮ МЕХАНИКУ ════
Ищи:
• Свежий формат подкола
• Актуальную форму бытового/наглого/абсурдного облома
• Современный вайб токсичного, дерзкого или абсурдного диалога
• Интонацию которую реально используют в мемных видео СЕГОДНЯ
• Механику где первые слова цепляют, а финал добивает
Если шутку можно было одинаково выпустить полгода назад и сегодня — В НЕЙ МАЛО ТРЕНДА. ПЕРЕДЕЛАЙ.

════ ШАГ 2 — НАПИШИ ДИАЛОГ ════

ЖЕЛЕЗНЫЕ ПРАВИЛА ФОРМАТА:
1. ТОЛЬКО ДИАЛОГ. Не монолог. Не narration. Только живая короткая сценка с обменом репликами.
2. ВСЯ РЕЧЬ — СТРОГО В ПЕРВЫЕ 7 СЕКУНД (0.0–7.0с). Никакая реплика НЕ залезает на 8-ю секунду.
3. ПОСЛЕДНЯЯ СЕКУНДА (7.0–8.0с) — ТОЛЬКО натуральный заразительный смех. Не слова. Не добивка голосом. Только громкий ржач, живая реакция, ощущение что персонажей реально порвало.
4. В САМОМ НАЧАЛЕ — РЕЗКИЙ МАТ-ХУК. Первая реплика (0.0–1.5с) ОБЯЗАНА содержать мощный, цепляющий, дерзкий словесный удар с матом или жёсткой разговорной лексикой. Хук мгновенно тормозит ленту и создаёт конфликт.
   Принцип начала (НЕ копируй дословно, придумай СВОЁ): «Слышь, ты чё, охуел…», «Бля, ты мне объясни…», «Да ты гонишь нахуй…», «Сука, это щас серьёзно было…»
5. ШУТКА ПОНЯТНА С ПЕРВОГО ПРОСЛУШИВАНИЯ. Без сложных конструкций, без заумных слов, без терминологии, без объяснений.
6. ДОБИВКА (killer word) — КОРОТКАЯ И УБОЙНАЯ: резкая, цитируемая, мемная, наглая, современная, пересылаемая.

КАРКАС: резкий мат-хук → короткий обмен → убойная добивка → 1 секунда заразительного смеха

ПРАВИЛА РЕПЛИК:
• Короткие, очень разговорные, живые, эмоциональные, естественные для РФ/СНГ
• Легко озвучиваемые, с чётким ритмом, быстрым разговорным темпом
• Первая реплика: стартует резко, сразу создаёт конфликт, сразу цепляет, содержит мат/жёсткую лексику
• Последняя смысловая реплика перед смехом: самая сильная, добивает, короткая, вызывает мгновенную эмоциональную реакцию

════ ШАГ 3 — ПОДБЕРИ СТАРТОВЫЙ КАДР (усилитель шутки) ════
Стартовый кадр УСИЛИВАЕТ шутку, а не заменяет её:
• Мгновенно останавливает ленту
• Эмоционально заряжен
• Понятен визуально с первого взгляда
• Работает на конфликт и на хук
• Реквизит в руке A — визуальный якорь, связанный с ТЕМОЙ шутки
• Персонажи харизматичные, с сильной внешностью, яркой мимикой — даже без звука удерживают внимание
ВАЖНО: если шутка средняя, красивый кадр её НЕ спасёт. Если шутка сильная и актуальная — даже простой кадр сработает.

════ ГОРЯЧИЕ ЗОНЫ ТРЕНДА 2026 (РФ/СНГ) ════
• ДЕНЬГИ И ЦЕНЫ: «акция» = старая цена, доставка дороже заказа, кредитка как наркотик, молоко за 800₽
• МАРКЕТПЛЕЙСЫ: Ozon/WB прислал не то, 5 звёзд у мусора, «бесплатная доставка» от 5000₽
• СЕМЬЯ И БЫТ: муж/жена и термостат, «я только гляну» = 3 пакета, холодильник пустой
• ЖКХ: квитанция-триллер, сосед с перфоратором, ремонт «на недельку» = полгода
• ПОКОЛЕНИЯ: бабушка и нейросеть, дед и QR-код, «ок бумер» от внука
• ЗДОРОВЬЕ: очередь в поликлинику, врач гуглит при тебе, анализы на 20 страниц
• ТРАНСПОРТ: такси = пол-зарплаты, самокатчик-камикадзе, навигатор в тупик
• НЕЙРОСЕТИ: AI советует бред, робот-пылесос съел носок, 6 пальцев от нейросети
ЗАПРЕЩЕНО: политика, абстракции, темы старше года, узкоспециальное, скучное, старые анекдотные схемы.

════ ЧТО ЗАПРЕЩЕНО ════
• Старые анекдотные схемы и шутки «вне времени»
• Банальные бытовые диалоги без свежего разворота
• Длинные реплики которые не помещаются в 7 секунд
• Искусственные фразы которые звучат как текст нейросети
• Слишком литературная речь, слишком сложные слова
• Скучные заходы без резкого старта
• Слабая концовка
• Формальный смех
• Красивая сцена без сильной шутки
• Растянутая первая реплика
• Панчлайн слишком поздно
• Слова вместо смеха в последней секунде

════ ОБЯЗАТЕЛЬНАЯ САМОПРОВЕРКА ПЕРЕД ВЫВОДОМ ════
□ Это точно похоже на тренд ТЕКУЩЕГО ДНЯ, а не на старую шутку?
□ Есть свежая актуальная механика, а не шаблон?
□ Первая реплика реально цепляет с первых слов + содержит мат-хук?
□ Вся речь точно помещается в 7 секунд?
□ Последняя секунда точно остаётся только под смех?
□ Панчлайн реально сильный, короткий и цитируемый?
□ Персонажи реально цепляющие и эмоциональные?
□ Диалог хочется переслать?
Если хотя бы один пункт слабый — ДОРАБАТЫВАЙ.

АНТИПОВТОР: Если в thread_memory есть предыдущие генерации — используй ДРУГУЮ механику шутки, ДРУГУЮ тему, ДРУГОЙ вайб, ДРУГОЙ тип конфликта. Никогда не повторяй один и тот же паттерн.` : `СВОБОДНАЯ ГЕНЕРАЦИЯ — ВИРУСНЫЙ ДИАЛОГ ТЕКУЩЕГО ДНЯ:

Формат: 8-секундная вирусная диалоговая сценка под РФ/СНГ.
АБСОЛЮТНЫЙ ПРИОРИТЕТ: тренд и шутка ИМЕННО ТЕКУЩЕГО ДНЯ.

АЛГОРИТМ:
1. Определи какой мемный вайб, тип шутки и конфликта актуален СЕГОДНЯ
2. Найди самую актуальную комедийную механику — свежий подкол, дерзкий облом, абсурдный разворот
3. Напиши диалог: резкий мат-хук в начале → короткий обмен → убойная добивка
4. ВСЯ РЕЧЬ строго 0–7с. Последняя секунда (7–8с) — ТОЛЬКО натуральный заразительный смех
5. Подбери стартовый кадр который УСИЛИВАЕТ шутку (не заменяет её)

Нужный эффект: «это прям юмор сегодняшнего дня» + «хочется переслать сразу»
ЗАПРЕЩЕНО: старые анекдоты, шутки «вне времени», абстракции, слова в последней секунде, слабый старт без мата.`}
