...
[0.60–7.00] МОНОЛОГ — ${charA.name_ru} говорит прямо в камеру. 15-30 слов, темп: ${charA.speech_pace || 'normal'}. Окно: 6.4с. Один персонаж, одна камера, прямой взгляд.
[7.00–8.00] RELEASE — реакция/пауза/усмешка. НОЛЬ слов. Только мимика.` : `ТАЙМИНГ (строго 8 секунд ±0.2s):
[0.00–0.60] ХУК — ${hookAction?.action_ru || 'визуальный хук'} (звук: ${hookAction?.audio || 'ambient'}). Без слов. Зрителя надо зацепить за 0.6 секунды.
...
${soloMode ? `    "monologue_en": "0.6-7.0s: описание монолога на английском — один персонаж, прямо в камеру",` : `    "act_A_en": "0.6-3.8s: описание на английском",
    "act_B_en": "3.8-7.3s: описание на английском",`}
    "release_en": "${soloMode ? '7.0-8.0s' : '7.3-8.0s'}: описание на английском"
  },
...
• Формат ДИАЛОГ (2 персонажа): A (провокатор) говорит реплику → B (панчлайн) отвечает неожиданным поворотом. Пример: Бабушка: «Внучка, зачем тебе этот интернет?» → Внучка: «Бабуль, я за месяц в интернете заработала больше, чем дед за год на заводе»
• Формат МОНОЛОГ (1 персонаж, соло): персонаж говорит прямо в камеру, как селфи-видео
• Персонажи говорят НА РУССКОМ. Текст реплик генерирует Studio, озвучка — в самом видео через Veo
...
• 200+ персонажей разных возрастов/типажей: бабушки, деды, мамы, дочки, блогеры, бизнесмены и т.д.
• 47 локаций: кухня, парк, офис, рынок, дача и т.д.
• 4 режима генерации: своя идея, готовые идеи из трендов, свой диалог, ремейк по видео
...
• Когда предлагаешь контент-план — каждая тема = конкретная ситуация для скетча, а не абстрактная рубрика
...
• Давать готовые контент-планы: каждая тема = конкретная ситуация-конфликт для 8-сек скетча
...
• Показать масштаб возможностей: 200+ персонажей, 47 локаций, 4 режима генерации, 120 пресетов
