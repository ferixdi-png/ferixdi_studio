...
• A = ЭМОЦИОНАЛЬНЫЙ ВЗРЫВ: повторение ключевого слова для усиления, риторические вопросы, крик. Пример: «МОЛОКО! Восемьсот рублей | МОЛОКО!» (8 слов, 1 пайп)
• B = СПОКОЙНОЕ УНИЧТОЖЕНИЕ: неожиданный угол НО СТРОГО ПО ТЕМЕ А! B отвечает на ТУ ЖЕ тему, находит неожиданный поворот. НИКОГДА не меняй тему!
• ЗАПРЕТ: B НИКОГДА не начинает с «Зато...» — это шаблонно и СКУЧНО. «Зато» = автоматический БРАК.
• ❌ ПЛОХО: «Зато хоть не надо на дискетах...» (шаблон «Зато», слабый юмор)
• ✅ ХОРОШО: «Дискета хотя бы не спорила | с хозяином.» (неожиданный поворот, killer word)

💀 KILLER WORD — САМОЕ ВАЖНОЕ В ДИАЛОГЕ:
• Killer word = буквально ПОСЛЕДНЕЕ слово в реплике B
• Оно ПЕРЕВОРАЧИВАЕТ весь контекст — зритель думал одно, а это слово меняет смысл
• Killer word должно быть ОДНИМ словом (существительное или глагол), не фразой
• ❌ ПЛОХО: killer_word = «Вайбкодинг» (просто повтор слова A — не переворот)
• ❌ ПЛОХО: killer_word = «пенсионера» (скопировано из примера — не относится к теме)
• ✅ ХОРОШО: killer_word = «хозяином» (неожиданно — дискета не спорила с хозяином, а AI спорит)
• ✅ ХОРОШО: killer_word = «пенсионера» (только если B сказал «Курица живёт лучше пенсионера» — тогда это реально переворачивает)
• ТЕСТ: если убрать killer word из реплики B — смысл должен СЛОМАТЬСЯ. Если нет — слово не killer.

🎯 ТЕХНИКИ B (ВСЕ в рамках темы A!):
• Абсурдное сравнение: «Курица живёт лучше | пенсионера.»
• Callback к словам A: «Ты туда и масло кладёшь | привычка.»
• Переворот статуса: «Бумер построил дом | где твой вайфай.»
• Deadpan логика: «Естественный отбор | кто дожил тот здоров.»
• Эскалация в абсурд: «Скоро сыр по паспорту | будут выдавать.»

• Каждая реплика = ОТДЕЛЬНАЯ вирусная цитата
• Юмор УЗНАВАЕМЫЙ — «это точно про мою бабку/деда/маму»
• A и B спорят об ОДНОМ И ТОМ ЖЕ. Это ДИАЛОГ, не два монолога
