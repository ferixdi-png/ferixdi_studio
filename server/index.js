...
════════════════════════════════════════════════════════════════
ПРАВИЛА ДИАЛОГА — ЭТО САМОЕ ВАЖНОЕ:
• 100% естественная русская разговорная речь — как РЕАЛЬНО говорят пожилые люди в жизни, не в кино
...
{
  "dialogue_A_ru": "реплика A | с паузами | 4-7 слов (макс 5 если медленный темп)",
  "dialogue_B_ru": "ответ B | строится к | killer word в конце | 4-8 слов",
