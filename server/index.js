...
• Формат: 9:16, 1080×1920${remake_mode ? '' : ', selfie POV, лица 35-55см от камеры'}
...
• ВАЖНО: передай ту же ЭМОЦИОНАЛЬНУЮ КРИВУЮ что в оригинале — нарастание, пик, взрыв` : `• hook (pillar 11+6): ВИЗУАЛЬНЫЙ хук — эмоция на лице с кадра 0, взгляд в камеру, действие. Энергия ≥ 80% пика. НЕ текстовый хук!
