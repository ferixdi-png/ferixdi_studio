...
10. FACE COMPOSITE BLOCK: В photo_scene_en для КАЖДОГО персонажа ОБЯЗАН быть ЕДИНЫЙ блок описания лица. Собери его из ВСЕХ biology tokens в порядке: face_silhouette → skin_color → eye → eyebrow → nose → mouth+lips+teeth → jaw+chin → cheekbone → forehead → nasolabial → undereye → hair → ear. Этот блок ИДЕНТИЧЕН в каждом ролике — это ЛИЦО персонажа
11. Wardrobe НИКОГДА не меняется между эпизодами — это УНИФОРМА персонажа
...
□ remake_veo_prompt_en содержит все 5 блоков: сцена/локация, ракурс камеры, персонажи с character_en, действие/движения, техпараметры?
□ remake_veo_prompt_en НЕ описывает selfie если в оригинале другой ракурс?
□ remake_veo_prompt_en длиннее 200 слов?` : `□ dialogue_A_ru содержит 6-15 слов? (посчитай!)
...
${soloMode ? `    "monologue_en": "0.6-7.3s: описание монолога на английском — один персонаж, прямо в камеру, killer word ≈ 7.1s",` : `    "act_A_en": "0.6-3.8s: описание на английском",
  ...
  "remake_veo_prompt_en": "УЛЬТРА-ДЕТАЛЬНЫЙ VEO ПРОМПТ — ТОЧНАЯ ВИЗУАЛЬНАЯ КОПИЯ ОРИГИНАЛА. 300-500 слов на английском. СТРУКТУРА ОБЯЗАТЕЛЬНА:\n1. СЦЕНА И ЛОКАЦИЯ (60-80 слов): точное место действия из оригинала — интерьер/улица/площадка, материалы стен/пола/фона, освещение (тип, направление, цветовая температура), атмосфера, детали заднего плана. ЗАПРЕЩЕНО менять локацию на selfie если в оригинале не selfie.\n2. РАКУРС КАМЕРЫ (30-40 слов): точный угол съёмки из оригинала — selfie POV / сбоку / спереди / сзади / сверху / снизу; дистанция — крупный план / средний / общий; движение камеры если есть.\n3. ПЕРСОНАЖИ В КАДРЕ (100-150 слов): для каждого персонажа — дословно вставь полный character_en токен из Identity Lock выше, затем опиши позу и положение в кадре точно как в оригинале.\n4. ДЕЙСТВИЕ И ДВИЖЕНИЯ (60-80 слов): что именно делает каждый персонаж, последовательность движений, жесты, мимика — ТОЧНО как в оригинале, адаптировано под наших персонажей. Если в оригинале спорт/танец/действие — описывай ИМЕННО это.\n5. ТЕХНИЧЕСКИЕ ПАРАМЕТРЫ (30-40 слов): smartphone camera feel, handheld micro-jitter, natural lighting, authentic texture — кожа, одежда, фон. 9:16 vertical. 8 seconds. Hyperrealistic. No text, no subtitles, no captions, no watermarks."` : ''}${product_info?.description_en || ctx.hasProductImage ? `,
