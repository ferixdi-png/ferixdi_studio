...
• 120 вирусных пресетов «Сюрприз» — клик → уникальный промпт, никогда не повторяется
...
• Показать масштаб возможностей: 200+ персонажей + конструктор, 144+ локаций + конструктор, 5 режимов (вкл. мем-ремейк), 120 пресетов, фото товара, референс стиля, English Adaptation, редактор диалога, раскадровка, антиповтор
