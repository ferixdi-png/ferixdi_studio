...
• 4 РАЗНЫЕ новости/события из результатов поиска
• Каждая идея — УНИКАЛЬНАЯ тема (политика, экономика, спорт, шоу-бизнес, технологии — РАЗНОЕ)
...
Используй болевые точки: ${painsSample}
• 4 идеи — каждая про ОТДЕЛЬНУЮ сферу жизни
...
✅ ХОРОШИЕ ПРИМЕРЫ:
• «Бабка купила 3 яйца и попросила рассрочку» (конкретика + абсурд, тема: цены)
...
═══ JSON ФОРМАТ КАЖДОЙ ИДЕИ ═══
{
  ...
  "virality": 8,
  "theme_tag": "одно слово: цены|здоровье|транспорт|технологии|дача|семья|жкх|работа|мода|еда|соцсети|образование|спорт|погода|политика|шоубиз|праздник"
}
